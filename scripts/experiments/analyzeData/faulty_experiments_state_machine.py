    ...
    def __init__(self, experiment_type):
        smach.State.__init__(self,
                             outcomes=['NEXT_MONITOR', 'END_MONITOR'],
                              input_keys=['acc_cum', 'cam_cum', 'odom_cum', 'imu_cum', 'result_cum'],
...
def main():
    ...
    reading_sm.userdata.bag_family = "collision_bags_bags"#"cob3-attempt-2301-" #TODO
